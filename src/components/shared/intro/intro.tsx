    ...
    return (
      <div className={styles.intro}>
        <div className={styles.message}>
          ...
          <h1>Theme is ready: <span>{global.name}</span></h1>
        </div>
        ...
        <ol>
          <li>Design your theme's templates</li>
          <li>Push theme to Github, then import into Built.js Studio</li>
          <li>Create a site from the theme</li>
        </ol>
      </div>
    );
  }
